                    ...
                    <div class="sp-slides">
                        <div class="slide-item sp-slide">
                           ...
                           <div class="slide-content">
                                ...
                                <div class="title sp-layer" data-show-transition="right" data-hide-transition="up" data-show-delay="500"> <span class="big-text">Megatask Technology</span> provides</div>

                                <div class="title sp-layer" data-show-transition="right" data-hide-transition="up" data-show-delay="500" >entire <span class="big-text">IT Solution</span> which are important</div>

                                <div class="title sp-layer" data-show-transition="right" data-hide-transition="up" data-show-delay="500" >to grow your<span class="big-text"> BUSINESS.</span></div>
            ...
            <div class="container"> 
                <div class="row">
                    <div class="col-md-7 col-sm-7 text-right">
                        ...
                        <div><em>We Are Professional Web Designing Team</em></div>
                        <div class="design-arrow inline-arrow"></div>
                        <p class="large">Our Web design company in Delhi specializes in the professional creation of unique websites.</p>
            ...
            <div class="container dark-content">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <a href="https://www.youtube.com/watch?v=sjJ_XFEgOXQ&amp;autoplay=1" class="btn-play fancybox-video"></a>
                        <div class="duration">Duration : <span>0:46</span></div>
                    </div>
                </div>
            </div>
        </section>
